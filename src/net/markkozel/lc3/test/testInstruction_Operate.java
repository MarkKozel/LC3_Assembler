...
public class testInstruction_Operate {
	...
	public final void testAddImm5() {
		Instruction_Operate InOp = new Instruction_Operate("ADD R0, R0, #5");
		assertEquals(InOp.toBinary(),ADD+R0+R0+Immdiate+Imm5_5);
		
		Instruction_Operate InOp1 = new Instruction_Operate("ADD R1, R2, #5");
		assertEquals(InOp1.toBinary(),ADD+R1+R2+Immdiate+Imm5_5);
		
		Instruction_Operate InOp2 = new Instruction_Operate("ADD R3, R4, #5");
		assertEquals(InOp2.toBinary(),ADD+R3+R4+Immdiate+Imm5_5);
		
		Instruction_Operate InOp3 = new Instruction_Operate("ADD R5, R6, #5");
		assertEquals(InOp3.toBinary(),ADD+R5+R6+Immdiate+Imm5_5);
		
		Instruction_Operate InOp4 = new Instruction_Operate("ADD R5, R7, #5");
		assertEquals(InOp4.toBinary(),ADD+R5+R7+Immdiate+Imm5_5);
	}
	
	@Test
	public final void testAddReg() {
		Instruction_Operate InOp = new Instruction_Operate("ADD R0, R0, R0");
		assertEquals(InOp.toBinary(),ADD+R0+R0+Register+RegFill+R0);
		
		Instruction_Operate InOp1 = new Instruction_Operate("ADD R1, R2, R0");
		assertEquals(InOp1.toBinary(),ADD+R1+R2+Register+RegFill+R0);
		
		Instruction_Operate InOp2 = new Instruction_Operate("ADD R3, R4, R5");
		assertEquals(InOp2.toBinary(),ADD+R3+R4+Register+RegFill+R5);
		
		Instruction_Operate InOp3 = new Instruction_Operate("ADD R7, R6, R0");
		assertEquals(InOp3.toBinary(),ADD+R7+R6+Register+RegFill+R0);
		
		Instruction_Operate InOp4 = new Instruction_Operate("ADD R2, R4, R6");
		assertEquals(InOp4.toBinary(),ADD+R2+R4+Register+RegFill+R6);
	}
	
	@Test
	public final void testAndImm5() {
		Instruction_Operate InOp = new Instruction_Operate("AND R0, R0, #5");
		assertEquals(InOp.toBinary(),AND+R0+R0+Immdiate+Imm5_5);
		
		Instruction_Operate InOp1 = new Instruction_Operate("AND R1, R2, #5");
		assertEquals(InOp1.toBinary(),AND+R1+R2+Immdiate+Imm5_5);
		
		Instruction_Operate InOp2 = new Instruction_Operate("AND R3, R4, #5");
		assertEquals(InOp2.toBinary(),AND+R3+R4+Immdiate+Imm5_5);
		
		Instruction_Operate InOp3 = new Instruction_Operate("AND R5, R6, #5");
		assertEquals(InOp3.toBinary(),AND+R5+R6+Immdiate+Imm5_5);
		
		Instruction_Operate InOp4 = new Instruction_Operate("AND R5, R7, #5");
		assertEquals(InOp4.toBinary(),AND+R5+R7+Immdiate+Imm5_5);
	}
	
	@Test
	public final void testAndReg() {
		Instruction_Operate InOp = new Instruction_Operate("AND R0, R0, R0");
		assertEquals(InOp.toBinary(),AND+R0+R0+Register+RegFill+R0);
		
		Instruction_Operate InOp1 = new Instruction_Operate("AND R1, R2, R0");
		assertEquals(InOp1.toBinary(),AND+R1+R2+Register+RegFill+R0);
		
		Instruction_Operate InOp2 = new Instruction_Operate("AND R3, R4, R5");
		assertEquals(InOp2.toBinary(),AND+R3+R4+Register+RegFill+R5);
		
		Instruction_Operate InOp3 = new Instruction_Operate("AND R7, R6, R0");
		assertEquals(InOp3.toBinary(),AND+R7+R6+Register+RegFill+R0);
		
		Instruction_Operate InOp4 = new Instruction_Operate("AND R2, R4, R6");
		assertEquals(InOp4.toBinary(),AND+R2+R4+Register+RegFill+R6);
	}
	
	@Test
	public final void testNot(){
		Instruction_Operate InOp = new Instruction_Operate("NOT R0, R0");
		assertEquals(InOp.toBinary(),NOT+R0+R0+NotFill);
		
		Instruction_Operate InOp1 = new Instruction_Operate("NOT R2, R1");
		assertEquals(InOp1.toBinary(),NOT+R2+R1+NotFill);
		
		Instruction_Operate InOp2 = new Instruction_Operate("NOT R4, R5");
		assertEquals(InOp2.toBinary(),NOT+R4+R5+NotFill);
		
		Instruction_Operate InOp3 = new Instruction_Operate("NOT R6, R7");
	...
	public final void testAllWithLabels(){
		...
		Instruction_Operate InOp = new Instruction_Operate("MyLabel ADD R5, R7, #5");
		assertEquals(InOp.toBinary(),ADD+R5+R7+Immdiate+Imm5_5);
		
		Instruction_Operate InOp1 = new Instruction_Operate("MyLabel ADD R5, R7, R0");
		assertEquals(InOp1.toBinary(),ADD+R5+R7+Register+RegFill+R0);
		
		Instruction_Operate InOp2 = new Instruction_Operate("MyLabel AND R5, R7, #5");
		assertEquals(InOp2.toBinary(),AND+R5+R7+Immdiate+Imm5_5);
		
		Instruction_Operate InOp3 = new Instruction_Operate("MyLabel AND R5, R7, R0");
		assertEquals(InOp3.toBinary(),AND+R5+R7+Register+RegFill+R0);
		
		Instruction_Operate InOp4 = new Instruction_Operate("MyLabel NOT R6, R7");
	...
	public final void testErrors(){
		...
		Instruction_Operate InOp1 = new Instruction_Operate("MyLabel ADD R5, R7, #1024");
